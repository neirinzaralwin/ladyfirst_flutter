...
extension TextStyleExtensions on Text {
  ...
  Text get white => copyWith(
    style:
        style?.copyWith(color: AppColor.white) ??
        const TextStyle(color: AppColor.white),
  );

  Text get black => copyWith(
    style:
        style?.copyWith(color: AppColor.black) ??
  ...
  Text get largeTitle => copyWith(
    style: style?.copyWith(fontSize: 30.0) ?? const TextStyle(fontSize: 30.0),
  );

  Text get title => copyWith(
    style: style?.copyWith(fontSize: 24.0) ?? const TextStyle(fontSize: 24.0),
  );

  Text get bodySmall => copyWith(
    style: style?.copyWith(fontSize: 12.0) ?? const TextStyle(fontSize: 12.0),
  );

  Text get bodyMedium => copyWith(
    style: style?.copyWith(fontSize: 14.0) ?? const TextStyle(fontSize: 14.0),
  );

  Text get bodyLarge => copyWith(
    style: style?.copyWith(fontSize: 16.0) ?? const TextStyle(fontSize: 16.0),
  );

  Text get headSmall => copyWith(
    style: style?.copyWith(fontSize: 18.0) ?? const TextStyle(fontSize: 18.0),
  );

  Text get headMedium => copyWith(
    style: style?.copyWith(fontSize: 20.0) ?? const TextStyle(fontSize: 20.0),
  );

  Text get headLarge => copyWith(
    style: style?.copyWith(fontSize: 22.0) ?? const TextStyle(fontSize: 22.0),
  );
